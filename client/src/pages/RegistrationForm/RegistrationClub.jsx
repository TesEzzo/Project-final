...
const RegistrationClub = () => {
    ...
    const handleNextStep = () => {
        if (inputValues.inputClubName && inputValues.inputVatNumber) {
          setStep(2);
        } else {
    ...
    const handleToFinalStep = () => {
        if (inputValues.inputPassword !== inputValues.inputConfirmPassword) {
            ...
            if (inputValues.inputClubName && inputValues.inputVatNumber && inputValues.inputEmail && 
                inputValues.inputPassword && inputValues.inputConfirmPassword) {
              setStep(3);
            } else {
              alert('Inserisci tutti i valori prima di passare al passo successivo.');
            }
    ...
    const handleFinalStep = () => {
        if (inputValues.inputClubName && inputValues.inputVatNumber && inputValues.inputEmail && 
            inputValues.inputPassword && inputValues.inputConfirmPassword && inputValues.inputCity && 
            inputValues.inputCAP && inputValues.inputAddress && inputValues.inputNumberAddress) {
                                    ...
                                    <div className="w-full h-full">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <div className="w-[80%] bg-gray-200 rounded-full flex">
                                                <div className="flex flex-row justify-start">
                                                    <div className="w-24 p-1 text-xs font-medium leading-none text-center text-blue-100 bg-blue-600 rounded-full">
                                                        Step 1
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="mt-4 mb-4">
                                            <label className="block mb-2 text-sm"> 
                                                Nome del club sportivo<span className="text-red-600">*</span>
                                            </label>
                                            <input type="text" className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none 
                                                focus:ring-1 focus:ring-blue-600" placeholder="Nome club sportivo" name="inputClubName"
                                                value={inputValues.inputClubName} onChange={handleInputChange} />
                                        </div>
                                        <div className="flex gap-4">
                                            <div className="mt-4 mb-4">
                                                ...
                                                <input type="text" className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none 
                                                    focus:ring-1 focus:ring-blue-600" name="inputOwnerFirstName" value={inputValues.inputOwnerFirstName} 
                                                    onChange={handleInputChange} placeholder="Nome" />
                                            </div>
                                            <div className="mt-4 mb-4">
                                                <label className="block mb-2 text-sm"> 
                                                ...
                                                <input type="text" className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none 
                                                    focus:ring-1 focus:ring-blue-600" name="inputOwnerLastName" placeholder="Cognome" 
                                                    value={inputValues.inputOwnerLastName} onChange={handleInputChange} />
                                            </div>
                                        </div>
                                        <div className="mb-4">
                                            <label className="block mb-2 text-sm"> 
                                            ...
                                            <input type="text" className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none 
                                                focus:ring-1 focus:ring-blue-600" placeholder="Partita IVA" name="inputVatNumber" 
                                                value={inputValues.inputVatNumber} onChange={handleInputChange} />
                                        </div>
                                ...
                                <div className="flex items-center justify-center p-6 sm:px-12 sm:py-10 md:w-1/2">
                                    <div className="w-full h-full">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <div className="bg-gray-200 rounded-full flex justify-center w-[80%]">
                                                <div>
                                                    <div className="w-24 p-1 text-xs font-medium leading-none text-center text-blue-100 bg-blue-600 rounded-full enterDivAnimation">
                                                        Step 2
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <button onClick={handleToFinalStep} className="px-6 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors
                                                duration-150 bg-blue-600 border border-transparent rounded-lg hover:bg-blue-700 focus:outline-none" 
                                                href="#">
                                                Prossimo
                                            </button>
                                    ...
                                    <div className="w-full h-full">
                                        ...
                                        <div className="flex gap-6">
                                            <div className="mb-4 mt-4">
                                                ...
                                                <input className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none
                                                    focus:ring-1 focus:ring-blue-600" placeholder="Indirizzo" type="email" name="inputAddress" 
                                                    />
                                            </div>
                                            <div className="mb-4 mt-4 w-[33%]">
                                                ...
                                                <input className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none
                                                    focus:ring-1 focus:ring-blue-600" placeholder="n° della via" type="number" name="inputNumberAddress" 
                                                    />
                                            </div>
                                        </div>
                                        <div className="mb-4">
                                            ...
                                            <input className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none
                                                focus:ring-1 focus:ring-blue-600" placeholder="Città" type="text" name="inputCity" 
                                                />
                                        </div>
                                        <div className="mb-4">
                                            <label className="block mb-2 text-sm">
                                            ...
                                            <input className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none
                                                focus:ring-1 focus:ring-blue-600" placeholder="Codice di avviamento postale" type="number" name="inputCAP" 
                                                />
                                        </div>
                                        <div className="flex justify-between">
                                            <div onClick={handlePreviousStep} className="cursor-pointer mt-[22px]">
