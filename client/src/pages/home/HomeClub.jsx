        ...
        <section className="mb-8">
          <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow ">
            ...
            <div class="p-5">
              ...
              <button class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 ">
                Read more
              </button>
            </div>
          </div>
