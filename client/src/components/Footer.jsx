...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-[#17202A] h-max w-full mt-2 text-pri">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="flex justify-between max-md:flex-col max-md:items-center">
            ...
            <div className="flex flex-row gap-8 justify-between mr-8 max-md:flex-col max-md:mr-0">
        ...
        <div className="flex justify-center pb-8">
          ...
          <a href="#" className="text-gray-500 hover ms-5">
            <svg
              className="w-4 h-4"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
