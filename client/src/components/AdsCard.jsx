    ...
    <>
      <div className="flex flex-col items-center m-8">
        ...
        <div className="flex flex-row gap-8 w-2/3">
          {/* //NOTE - card1}*/}
          <div className="group/item flex flex-col border-2 rounded-3xl border-none w-1/3 h-max shadow-xl bg-white transition ease-in-out delay-100  items-center justify-between p-8">
            <div className=" flex flex-col justify-center">
              ...
              <p className="text-2xl text-center self-center text-ellipsis overflow-hidden w-full h-32 hover:overflow-y-auto  ">
